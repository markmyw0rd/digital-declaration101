    ...
    <main className="max-w-5xl mx-auto p-6 space-y-6">
      <header className="space-y-1">
        ...
        <p className="text-sm text-gray-600">
          Envelope {env.envelope.id} • Unit: {env.envelope.unit_code} • Status: {env.envelope.status} • Your role:{" "}
          <b>{role}</b>
        </p>
      </header>
      ...
      <Section title="Purpose of this document">
        <p className="text-sm text-gray-700">
          This document confirms the apprentice/student has demonstrated the required skills and knowledge to industry
          standard. The student declares the work is their own; the workplace supervisor verifies consistent
          performance; and the RTO assessor reviews the evidence and makes the final competency decision.
        </p>
      </Section>
